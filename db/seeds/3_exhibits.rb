...
# Past Exhibits
FactoryBot.create(:exhibit, :with_end_date, :with_content_sections, :as_featured, banner: Image.first,
...
# Ongoing Exhibits
FactoryBot.create(:exhibit, :with_content_sections, :as_featured, banner: Image.first, poster: Image.last,
